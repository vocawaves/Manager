...
public class VlcControl : NativeControlHost
{
    ...
    /// </summary>
    public static readonly DirectProperty<VlcControl, MediaPlayer?> MediaPlayerProperty =
        AvaloniaProperty.RegisterDirect<VlcControl, MediaPlayer?>(
            nameof(MediaPlayer),
            o => o.MediaPlayer,
            (o, v) => o.MediaPlayer = v,
